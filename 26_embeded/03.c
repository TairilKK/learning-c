...
void resetRGB()
{
	...
	HAL_GPIO_WritePin(GPIOB, RED, GPIO_PIN_RESET);
...
int main(void)
{
  ...
  while (1)
  {
	...
	Joy_RGB();
	HAL_GPIO_TogglePin(GPIOC, D2);
	Joy_RGB();
	HAL_GPIO_TogglePin(GPIOC, D3);
	Joy_RGB();
	HAL_GPIO_TogglePin(GPIOC, D4);
	Joy_RGB();
	HAL_GPIO_TogglePin(GPIOE, D5);
	Joy_RGB();
	HAL_GPIO_TogglePin(GPIOD, D6);
	Joy_RGB();
	HAL_GPIO_TogglePin(GPIOE, D7);
	Joy_RGB();
	HAL_GPIO_TogglePin(GPIOE, D8);
...
static void MX_GPIO_Init(void)
{
  ...
  //LED_PWM_R
  GPIO_InitStruct.Pin = BLUE;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  //LED_PWM_G
  GPIO_InitStruct.Pin = GREEN;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  //LED_PWM_B
  GPIO_InitStruct.Pin = RED;
